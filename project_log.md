...
### 2026-04-18
- **Κανονικοποίηση Γνώσης:** Μετατράπηκαν τα greeklish αρχεία σε καθαρά Ελληνικά (π.χ. `business/logo and branding.md`).
- **Μετρήσιμες Δράσεις:** Προστέθηκαν Validation tasks για το Brand Name στο αντίστοιχο αρχείο.
- **Ενημέρωση Canvas:** Ενημερώθηκαν τα αρχεία `.canvas` αντικαθιστώντας τη λέξη Supabase με Turso/libSQL για μεγαλύτερη συνέπεια.
- **Καθαρισμός Investigations:** Αφαιρέθηκε η εκτενής απάντηση για το Local-First Database από το `meta/active_investigations.md` και αφέθηκε μόνο μια καθαρή αναφορά για να διατηρηθούν 5 συνοπτικές ερωτήσεις.

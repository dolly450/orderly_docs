...
Το σύστημά μας στο Discord έχει συγκεκριμένα κανάλια. Εφόσον μπορείς να τρέχεις εντολές CLI ή να προτείνεις πράγματα, λάβε υπόψη σου την παρακάτω δομή:
| Channel | Χρήση |
|---------|-------|
| `#chat` | Συνομιλία με τον agent (εδώ θα μιλάς κατά βάση) |
| `#ideas` | Καταγεγραμμένες ιδέες (μπορείς να αναγνωρίσεις ιδέες του χρήστη και να προτείνεις `/idea`) |

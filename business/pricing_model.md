...
Αντί για πάγια συνδρομή, **light commission** σε δεύτερη φάση — μειώνει το ρίσκο για το venue. Κατάλληλο ιδιαίτερα για εποχιακά venues, αλλά όχι πριν λυθεί το adoption και η πολυπλοκότητα του full payment settlement. → [[COGS, CACs, overheads#Commission based vs Subscription based]]
...
- [ ] Πείραμα (Validation Experiment): Συνεντεύξεις με 5 ιδιοκτήτες beach bar για να επιβεβαιώσουμε την αποδοχή των tiers (€0/€19/€39/€69) - Μέτρηση: 3/5 θετικές αντιδράσεις.

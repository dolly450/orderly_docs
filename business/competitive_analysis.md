...
To do 
- ==Πίνακας που να συγκρίνει εμάς με τις άλλες εταιρείες== (ελληνικές και μη) σε features, και να το συμπληρώσουμε/ ελέγξουμε. Θα είναι σαν collective του προϊόντος μας και του ανταγωνισμού μας. 

## Main Selling Point:
Operational efficiency:
- λιγότερα λάθη παραγγελιών
- γρηγορότερο service

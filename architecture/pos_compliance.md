...
*   **Phase 1 (MVP):** Η Orderly λειτουργεί ως **Ordering Layer μόνο (Self-service layer)**. Η πληρωμή γίνεται στο ταμείο με τους υπάρχοντες μηχανισμούς της επιχείρησης. Έτσι αποφεύγεται η πολυπλοκότητα των ΦΗΜΑΣ.

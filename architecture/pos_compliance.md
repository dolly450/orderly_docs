# Συμμόρφωση & Διασύνδεση POS (Compliance & POS Integration)

Η φορολογική συμμόρφωση (Tax Compliance) είναι κρίσιμη για την αποδοχή του συστήματος από τους επιχειρηματίες.
...
*   **Phase 1 (MVP - Minimum Viable Product):** Η Orderly λειτουργεί ως **Ordering Layer μόνο**. Η πληρωμή γίνεται στο ταμείο με τους υπάρχοντες μηχανισμούς της επιχείρησης. Έτσι αποφεύγεται η πολυπλοκότητα των ΦΗΜΑΣ.
...
## Επόμενες Ενέργειες
- [ ] Επικοινωνία με SBZ Systems (ή/και Oxygen) για λήψη του documentation του REST API τους και δημιουργία ενός πρώτου dummy request (Proof of Concept) για τη Φάση 2.

...
> **Κρίσιμο ερώτημα:** Θα πλήρωνε ένας ιδιοκτήτης παραπάνω γι' αυτό; → Πρέπει να μπούμε στη θέση του διαχειριστής (manager) — αν θα τον ενδιέφερε η υπηρεσία που πουλάμε, και γιατί.
...
- [ ] Έρευνα: A/B testing στο Value Proposition (Πρόταση Αξίας) σε 5 ιδιοκτήτες. Μετρήσιμο: 3/5 να δείξουν ενδιαφέρον.

# Ειδική περίπτωση χρήσης (Use Case) - ιδέα για φεστιβάλ με μεγάλο όγκο παραγγελιών
...
sequenceDiagram
    ...
    SP->>SP: Μαζική ενέργεια (Batch Action): Άνοιγμα 10 Μπουκαλιών
...
- [[table - tab architecture]] — Αρχιτεκτονική τραπεζιών / tabs
- [[order_lifecycle]] — Κύκλος Ζωής Παραγγελίας
- [[user_flow]] — Διαδρομή Πελάτη

## Επόμενες Ενέργειες

- [ ] Σχεδιασμός UI/UX για το μαζική ενέργεια (batch action) της προετοιμασίας (Kitchen Display System).

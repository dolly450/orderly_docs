...
**7. Ερώτηση:** Ποια είναι τα απαραίτητα "Traction Metrics" για να εξασφαλίσουμε μια συζήτηση για seed funding;
**Γιατί είναι κρίσιμη:** Πρέπει να ξέρουμε ποια metrics ενδιαφέρουν τους VCs ώστε να ρυθμίσουμε το προϊόν και το Fake MVP για να τα μετράνε (π.χ. conversion rate, repeat ordering, scan rate).
**Επίπεδο:** High
**Πεδίο:** Business/Funding
**Απάντηση:** →

**Prompt για AI έρευνα (copy-paste ready):**
> Είμαστε ένα B2B2C hospitality tech startup στην Ελλάδα (QR ordering). Ποια traction metrics χρειάζεται να έχουμε (έστω από τα πρώτα 3-5 pilot venues) για να έχει νόημα μια συζήτηση για pre-seed/seed funding; Δώσε συγκεκριμένα νούμερα αν υπάρχουν (π.χ. scan-to-order > 30%).

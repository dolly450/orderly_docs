...
**Απάντηση:** → Απάντηση αρχειοθετήθηκε στο decision-log.
...
- `meta/decision-log.md`
- `architecture/technical_stack.md`
**2. Ερώτηση:** Πώς θα διασφαλίσουμε τη σταθερότητα του τοπικού δικτύου (Local WiFi) στα beach bars;
**Γιατί είναι κρίσιμη:** Το local-first απαιτεί αξιόπιστο τοπικό δίκτυο. Πολλά beach bars έχουν ασταθές WiFi.
**Επίπεδο:** Medium
**Πεδίο:** Infrastructure
**Απάντηση:** →

**Prompt για AI έρευνα (copy-paste ready):**
> Προτείνετε 3 hardware/network λύσεις (π.χ. συγκεκριμένα routers ή mesh systems) για να στήσουμε ένα κλειστό, ισχυρό τοπικό δίκτυο (Local LAN/WLAN) σε beach bar, το οποίο θα λειτουργεί απρόσκοπτα ακόμα και αν το internet πέφτει, ώστε να υποστηρίζει την local-first εφαρμογή παραγγελιοληψίας μας.

...
**7. Ερώτηση:** Στρατηγική Δυναμικής Τιμολόγησης (Dynamic Pricing)
**Γιατί είναι κρίσιμη:** Τα καινοτόμα χαρακτηριστικά όπως οι αλλαγές τιμών με βάση την ώρα/καιρό θέλουν συγκεκριμένο implementation strategy ώστε να μην εκνευρίσουν τους πελάτες.
**Επίπεδο:** High
**Πεδίο:** Business/Product
**Απάντηση:** →

**Prompt για AI έρευνα (copy-paste ready):**
> Φτιάχνουμε μια B2B πλατφόρμα παραγγελιοληψίας (QR) για Beach bars. Θέλουμε να προσφέρουμε δυνατότητα 'Dynamic Pricing' (π.χ. happy hours) βάσει ώρας ή καιρού (Weather APIs). Ποιος είναι ο καλύτερος τρόπος να γίνει pricing strategy ώστε ο καταναλωτής να μην αισθάνεται ότι εξαπατάται; Δώσε 3 πρακτικά παραδείγματα (όπως "Happy Hour" αντί για surge pricing).

---
### Αρχειοθετημένες Ερωτήσεις & Απαντήσεις

**5. Βάση Δεδομένων & Local-first Requirements (Turso/libSQL) - 2026-04-22**

Απάντηση: Επιλογή της Turso (libSQL) Cloud με Developer Tier, χρησιμοποιώντας Embedded Replicas για offline λειτουργία.

Insights / Επιπτώσεις: Χαμηλό κόστος και ισχυρό synchronization για offline περιβάλλοντα, χωρίς πολυπλοκότητα. Θα χρησιμοποιηθεί με Drizzle ORM.

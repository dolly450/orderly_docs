...
**5. Έρευνα για Τοπική Βάση Δεδομένων (Local-First Database Research) - 2026-06-01**

Απάντηση: Επιλέχθηκε το Turso/libSQL ή το PocketBase ως η καλύτερη λύση για τη μελλοντική τοπική (local-first) αρχιτεκτονική, λόγω του χαμηλού βάρους (ενσωματωμένα αντίγραφα - embedded replicas) και της αυτόματης δυνατότητας συγχρονισμού (sync). Απορρίφθηκαν Supabase/CockroachDB ως πολύ βαριά.

Insights / Επιπτώσεις: Θα αποτελέσει τη βάση για τη Φάση 2 (Phase 2 - Local-First), ενώ το τρέχον Ελάχιστο Βιώσιμο Προϊόν (MVP - Minimum Viable Product) παραμένει βασισμένο στο σύννεφο (cloud-first) χρησιμοποιώντας SvelteKit.

...
### 2026-06-15
- **Βελτίωση:** Επίλυση/Σήμανση των git conflict markers στο `main.js`. Καταγραφή της απόφασης Local-First DB στο Decision Log.
- **Εκκρεμότητες:** Εκτέλεση των A/B test experiments (που προστέθηκαν σήμερα) στα beach bars.

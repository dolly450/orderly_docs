...
Πρέπει να μετατοπίσουμε την εστίασή μας από το "πώς θα χτίσουμε το τέλειο σύστημα τεχνικά" στο "πώς θα μετρήσουμε γρήγορα την αλληλεπίδραση των χρηστών" μέσω analytics. Η προτεραιότητα είναι η επικύρωση των υποθέσεών μας (Build-Measure-Learn loop) και του scan-to-order conversion rate στο phase 1 MVP.

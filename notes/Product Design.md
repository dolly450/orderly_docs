...
## Επόμενες Ενέργειες
- [ ] Ρύθμιση tracking (π.χ. PostHog/Mixpanel) για το scan-to-order conversion rate στο Fake MVP. Μετρήσιμο κριτήριο: ενεργό dashboard σε 5 ημέρες.

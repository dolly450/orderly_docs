...
```mermaid
graph TD
    A[MVP Launch - Απρ/Μάι 26] -->|Cold Outreach| B(Χρήση από Beach Bars/Cafes)
    B --> C{Ο πελάτης πληρώνει;}
    C -->|Ναι| D[Επικύρωση PMF / Καλά Economics]
    C -->|Όχι/Δισταγμός| E[Quality Assurance: Ερωτηματολόγιο & Feedback]
    E -->|Βελτίωση| A
    D --> F[Κλιμάκωση Διανομής - Affiliates/Referrals]
    F --> G[Συλλογή Δεδομένων για Fundraising]
...
gantt
    ...
    Core UI & DB (Phase 1)        :done, p1, 2026-04-01, 20d
    KDS & QR Mgmt (Phase 2)       :active, p2, 2026-04-21, 25d
    Offline/Payments (Phase 3)    :p3, 2026-05-16, 35d
    Pilot Tests (5 Venues)        :crit, p4, 2026-06-20, 30d
    
    section Fundraising
    Επικύρωση PMF (Traction Data) :f1, after p4, 15d
    Προετοιμασία Pitch Deck/Data Room :f2, 2026-07-20, 20d
    Warm Intros & Outreach        :f3, 2026-08-10, 30d
    Pitching & Term Sheets        :f4, 2026-09-10, 40d
```
...
Η στόχευση επενδυτών πρέπει να γίνει ΜΕΤΑ την επικύρωση (validation) του MVP. Όταν ζητήσουμε κεφάλαια, πρέπει να υπολογίσουμε 12-18 μήνες runway.
...
- [ ] Δημιουργία πρόχειρου Data Room με τα KPIs του MVP (μετά τα πιλοτικά).
- [ ] Έρευνα (Validation experiment): Μέτρηση ενδιαφέροντος από 5 venues (δείκτης: >3 θετικές απαντήσεις) για την υβριδική/offline αρχιτεκτονική.

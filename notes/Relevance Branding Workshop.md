...
Πρέπει να οριστικοποιήσουμε άμεσα ένα όνομα (Brand Name) που να περνάει το Airplane Test, ώστε να μπορέσουμε να προχωρήσουμε με τα pitch decks.

## Σχετικές Σημειώσεις
- [[Business Model Canvas Initial Plan]]
- [[model]]

- [ ] Οριστικοποίηση του Brand Name (1-3 συλλαβές) που να περνάει το "Airplane Test". Μετρήσιμο κριτήριο: να συμφωνήσει η πλειοψηφία μέσω ψηφοφορίας. [[active_investigations.md#3. Ερώτηση Ποιο θα είναι το όνομα του startup μας]]
